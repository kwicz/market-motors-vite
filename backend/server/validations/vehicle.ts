...
export const bulkCarOperationSchema = z.object({
  carIds: z
    ...
    .max(100, 'Cannot perform bulk operations on more than 100 cars at once'),
  operation: z.enum(
    ['delete', 'feature', 'unfeature', 'stock', 'unstock', 'update'],
    {
...
export type CarStatsInput = z.infer<typeof carStatsSchema>;
